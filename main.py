...
from config import POSTS_FILE_PATH, COMMENTS_FILE_PATH, BOOKMARKS_FILE_PATH, LOG_FILE_PATH
from utils import get_comments_ending_form, add_tag_list
...
def page_search():
    ...
    return render_template('search.html', posts_found_total=posts_found_total,posts=requested_posts,user_request=user_request)
